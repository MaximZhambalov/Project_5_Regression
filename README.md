...
# <center> Проект 5: Прогнозирование длительности поездки на такси </center>
...
- была построена модель, предсказывающая длительность поездки на такси. Финальное значение метрики ***RMSLE*** = $0.379$.